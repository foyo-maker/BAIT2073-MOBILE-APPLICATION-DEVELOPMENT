...
class WorkOutAdapter (private val context : Context, val listener:WorkoutClickListener): RecyclerView.Adapter<WorkOutAdapter.WorkoutViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): WorkoutViewHolder {
        ...
        return WorkoutViewHolder(
            LayoutInflater.from(parent.context)
                .inflate(R.layout.recycleview_plan, parent, false)
        )
    }
    ...
    inner class WorkoutViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val workout_layout = itemView.findViewById<CardView>(R.id.plan_workout_layout)
